...
# WICHTIG: --with-config-file-scan-dir hinzugefügt!
...
# Extensions konfigurieren (BEVOR php.ini kopiert wird)
...
# Debug: Extensions-Verzeichnis anzeigen
RUN echo "=== Checking extension files ===" \
    && ls -la /usr/local/lib/php/extensions/no-debug-zts-*/ || echo "Extension dir not found!" \
